...
import { addNode, fetchAppContent, flowContentState, initSubscribe } from '@/stores/app-flow.store';

import ActionBar from '@/pages/app/components/app-flow/components/action-bar';
import AttributePanel from '@/pages/app/components/app-flow/components/attribute-panel';
...
const EditFlowContent: React.FC = memo(() => {
  ...
  const snap = useSnapshot(flowContentState);
  const {
    onNodesChange,
    onEdgesChange,
    onConnect,
